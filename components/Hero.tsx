  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute w-[800px] h-[800px] bg-neon-green/10 rounded-full blur-[120px] pointer-events-none"
      />
        ...
        <div className="relative w-full max-w-4xl aspect-video flex items-center justify-center">
          ...
          >
             ...
             <div className="flex gap-1 mt-1">
                {[1,2,3,4,5].map(i => <Star key={i} className="w-3 h-3 fill-solar-yellow text-solar-yellow" />)}
             </div>
          </motion.div>
          ...
          >
            <Image 
              ...
              width={800}
              height={800}
              className="w-full h-full object-contain drop-shadow-[0_50px_100px_rgba(180,255,57,0.3)]"
            />
          </motion.div>
      ...
      <div className="absolute bottom-0 left-0 w-1/2 h-full bg-gradient-to-r from-hot-pink/5 to-transparent pointer-events-none" />
    </section>
  );
};
